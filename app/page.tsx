    ...
    <main className="min-h-screen px-4 py-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="rounded-[32px] border border-white/10 bg-slate-950/80 p-4 shadow-2xl shadow-slate-950/30 backdrop-blur sm:p-6 lg:p-8">
          <header className="flex flex-col gap-4 border-b border-white/10 pb-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 p-1">
              <button
                ...
                className={`rounded-full px-3 py-2 text-sm ${lang === "en" ? "bg-white text-slate-900" : "text-slate-300"}`}
              >
                EN
              </button>
              <button
                onClick={() => changeLang("vi")}
                className={`rounded-full px-3 py-2 text-sm ${lang === "vi" ? "bg-white text-slate-900" : "text-slate-300"}`}
              >
                VI
              </button>
            </div>
          ...
          <section className="grid gap-6 pt-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            <div>
            ...
            <div className="rounded-[28px] border border-white/10 bg-white/10 p-4 shadow-xl shadow-blue-950/20 sm:p-6">
              {userEmail ? (
                <div>
                  ...
                  <h2 className="mt-3 text-2xl font-semibold text-white">{userEmail}</h2>
                ...
                <div>
                  <div className="flex gap-2 rounded-full bg-slate-900/70 p-1">
                    <button
                      ...
                      className={`flex-1 rounded-full px-4 py-2 text-sm font-medium ${mode === "login" ? "bg-white text-slate-900" : "text-slate-300"}`}
                    >
                      {t.login}
                    </button>
                    <button
                      onClick={() => setMode("signup")}
                      className={`flex-1 rounded-full px-4 py-2 text-sm font-medium ${mode === "signup" ? "bg-white text-slate-900" : "text-slate-300"}`}
                    >
                      {t.signup}
                    </button>
                  </div>
